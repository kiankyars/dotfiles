...
4. Add the human-time label and a segment of `~/Music/Music/Media.localized/Music/Unknown Artist/Unknown Album/Minecraft.mp3`, choosing a fresh valid starting offset. Save the MP4 to `~/Downloads` and verify it with `ffprobe` and a full decode.
